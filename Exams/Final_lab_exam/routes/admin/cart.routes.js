...
// ✅ GET Add to Cart (for anchor tag links like <a href="/admin/cart/add/:id">)
router.get('/cart/add/:id', authorize, async (req, res) => {
...
// ✅ POST Add to Cart (for form submissions or fetch/AJAX)
router.post('/add-to-cart/:id', authorize, async (req, res) => {
   console.log("✅ POST /cart/add hit with ID:", req.params.id);
  const productId = req.params.id;
